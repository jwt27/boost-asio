...
#  define BOOST_ASIO_OS_DEF_IPPROTO_IPV6 0
# else
#  define BOOST_ASIO_OS_DEF_IPPROTO_IPV6 IPPROTO_IPV6
# endif
# define BOOST_ASIO_OS_DEF_IPPROTO_TCP IPPROTO_TCP
...
# define BOOST_ASIO_OS_DEF_IP_TTL IP_TTL
# if defined(__DJGPP__)
#  define BOOST_ASIO_OS_DEF_IPV6_UNICAST_HOPS 0
#  define BOOST_ASIO_OS_DEF_IPV6_MULTICAST_IF 0
#  define BOOST_ASIO_OS_DEF_IPV6_MULTICAST_HOPS 0
#  define BOOST_ASIO_OS_DEF_IPV6_MULTICAST_LOOP 0
#  define BOOST_ASIO_OS_DEF_IPV6_JOIN_GROUP 0
#  define BOOST_ASIO_OS_DEF_IPV6_LEAVE_GROUP 0
# else
#  define BOOST_ASIO_OS_DEF_IPV6_UNICAST_HOPS IPV6_UNICAST_HOPS
#  define BOOST_ASIO_OS_DEF_IPV6_MULTICAST_IF IPV6_MULTICAST_IF
#  define BOOST_ASIO_OS_DEF_IPV6_MULTICAST_HOPS IPV6_MULTICAST_HOPS
...
# if defined(__DJGPP__)
// Not supported.
#  define BOOST_ASIO_OS_DEF_SA_RESTART 0
